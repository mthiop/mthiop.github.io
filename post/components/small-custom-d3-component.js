...
class SmallCustomD3Component extends D3Component {
...
//      .style('height', '100%');
	...
	svg
	  ...
	  // Robot setup
	const robotData = this.robotData = [[30,30]];
	svg.append("circle")
	...
	const obstacleData = this.obstacleData = [[255,245]];
...
module.exports = SmallCustomD3Component;
