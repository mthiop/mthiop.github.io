...
P2: 1.Semester
\begin{itemize}
\item deutlich und verständlich erklärt
\item gute Visualisierung 
\item experimentieren mit Parameter und Animation sehr gut
...
Informatik-Interessierte (Abitur):%TODO Anahid vervollständigen
\begin{itemize}
...
Informatik-Studierende (1.-3. Semester):%TODO Anahid vervollständigen
\begin{itemize}
...
Informatik-Studierende (über dem  3. Semester):%TODO Anahid vervollständigen
\begin{itemize}
...
In der Kategorie der 1.-3. Semester-Studierenden %TODO Anahid Auswertung tests
...
%TODO Anahid Kurze Zusammenfasung von tester
