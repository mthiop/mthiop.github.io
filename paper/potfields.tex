...
Die Evaluation hat gezeigt, dass der Algorithmus sehr verständlich erklärt wird und die Animation die Problematik deutlich macht. Die Tester fanden es sehr gut, dass man mit der Animation und dne Parameter interaktiv experimentieren konnte, um eigene Szenarien auszuprobieren. 
Da es sich um einen Prototypen handelt gibt es natürlich mögliche Erweiterungen und  Aspekte die man verbessern könnte. Durch die Evaluation konnten wir einige Kommentare auch schon einarbeiten. 
...
Das Projektergebnis ist unter https://mthiop.github.io/ zu finden. Eine Anleitung wie man die Seite bedient, kann man sich unter VIMEO LINK anschauen.  %TODO insert link 