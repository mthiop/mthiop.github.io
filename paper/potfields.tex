...
\begin{equation}
	F_{\text{anziehend}}(q_r, q_z) = - \epsilon \cdot \frac{q_r - q_z}{\lvert q_r - q_z \rvert}
\end{equation}
...
\end{itemize}
Für die Erklärung des Algorithmus wurde ein schrittweiser Aufbau gewählt. Anstatt die Animation der Pfadplanung direkt zu zeigen wird das Beispiel zunächst schriftlich erklärt. Ziel ist es, den Fokus des Benutzers auf die Erklärung zu lenken, da Animationen das Potential zur Ablenkung haben.
Als anschauliches Beispiel wurde das Thema Star Wars mit den Robotern C3PO und R2D2 gewählt. Star Wars ist den meisten Menschen ein Begriff. In unserem Beispiel möchte R2D2
